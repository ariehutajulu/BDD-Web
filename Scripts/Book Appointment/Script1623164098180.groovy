...
WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/textarea_Comment_comment'), 'Mau cat rambut')
...
WebUI.click(findTestObject('Page_CURA Healthcare Service/homepage_history'))
